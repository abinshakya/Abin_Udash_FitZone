...
urlpatterns = [
    ...
    path('trainer/booking/<int:booking_id>/reject/', views.trainer_reject_booking, name='trainer_reject_booking'),
    path('trainer/booking/<int:booking_id>/cancel/', views.trainer_cancel_booking, name='trainer_cancel_booking'),
